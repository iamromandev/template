...
class Base(models.Model):
    ...
    updated_at: datetime = fields.DatetimeField(auto_now=True, db_index=True, db_default=Now())
...
class BaseSchema(BaseModel):
    ...
    def to_dict(
        ...
        data = self.model_dump(exclude=exclude_fields, exclude_none=exclude_none, exclude_unset=exclude_unset)
    ...
    def safe_dump(
        ...
        data = self.to_dict(exclude_fields=exclude_fields, exclude_none=True, exclude_unset=True)
        logger.info(f"{self._tag}|to_dict(): {data}")
        return data
